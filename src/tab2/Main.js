          ...
          <TouchableOpacity onPress={() => this.props.navigation.navigate('Detail')}>
            <View style={subContainer}>
              <View style={titleContainer}>
                <Image style={thumbImg} source={{ uri: 'https://static.dealer.com/v9/variations/oem-bmw/0002/v1/images/index-bb-3.jpg?r=1502896527000' }} />
                <View style={titleContainer2}>
                  <Text style={h1} numberOfLines={1} ellipsizeMode='tail'>BMW i8 Coupé</Text>
                </View>
              </View>
